...
void a5Init(void)
{
    ...
    Serial.begin(9600);  // Initialize serial port.  19200 baud default matches Alpha5 library examples.
    Serial1.begin(9600); // Initialize serial port.  19200 baud default matches Alpha5 library examples.
